...
namespace Infusio.Http
{
    ...
    public class InfusioClient
    {
        ...
        public static Option<(string name, object value)> RequestParameter(string name, object value) =>
        ...
        public static string MakeUri(string relative, params Option<(string name, object value)>[] values) => ifNone(
